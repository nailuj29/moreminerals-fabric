...
public class MoreMineralsBlocks {
    ...
    public static final Block BLOCK_OF_COPPER = new Block(FabricBlockSettings.of(Material.METAL).hardness(3.0f).resistance(6.0f).breakByTool(FabricToolTags.PICKAXES, 1).build());
}
